...
const CSS_BUDGETS = [
  ...
  ['griffinjs-fields-css', kbBudget(1.7), GRIFFIN_FIELDS_CSS],
];
...
const GRIFFIN_FIELDS_BUDGET = Math.round(9.7 * 1024);
const GRIFFIN_FIELDS_SET_BUDGET = Math.round(12.3 * 1024);
