/*!
 * Griffincss Utils — Runtime v0.26.0
...
(function (factory) {
  ...
  function autoStart() {
    ...
    function settle() {
      ...
      // Наблюдение за живым деревом включено по умолчанию — с Этапа 47
      // так же и у ядра: вставленная позже карточка без него осталась бы
      // с квадратными углами молча.
